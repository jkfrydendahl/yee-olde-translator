...
- Add musical or rhythmic cadence to the prose`
  ...
  const languageInstruction = language !== 'en' 
    ? `\n\nOUTPUT LANGUAGE: ${langConfig.name}\nWrite the entire translation in ${langConfig.name}, applying the medieval/archaic style conventions of that language. Use archaic ${langConfig.name} vocabulary, grammar, and expressions equivalent to the English style rules below.`
    : '';
...
Your task: Transform the following modern text into ${styleConfig.description.toLowerCase()}. Be verbose, theatrical, and delightfully unnecessary. Every mundane statement should become an elaborate proclamation!${languageInstruction}
